  ...
  return (
    <div className={"w-100 border-b-slate-300 border-b-[2px] flex flex-row px-5 py-5 space-x-2 h-[80px]" + (isMobile ? " justify-between items-center": " justify-end items-center")}>
      ...
      <div className="flex items-center space-x-2">
        <div className="p-2 border-2 rounded-md text-slate-500 cursor-pointer hover:text-slate-600" title="Download Expenses Report PDF" onClick={() => getPDF()}>
          <FaDownload />
        </div>
        <div id="avatar-div">
